...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "SIGNATURE_SCHEMA": (".signatures", "SIGNATURE_SCHEMA"),
    "SIGNATURE_VERSION": (".signatures", "SIGNATURE_VERSION"),
    "AdaptiveSignatureMemory": (".signatures", "AdaptiveSignatureMemory"),
    "SignatureMemoryConfig": (".signatures", "SignatureMemoryConfig"),
    "SignaturePrediction": (".signatures", "SignaturePrediction"),
    "SignatureUpdate": (".signatures", "SignatureUpdate"),
    "path_signature": (".signatures", "path_signature"),
    "signature_dimension": (".signatures", "signature_dimension"),
    "BRIDGE_SCHEMA": (".bridge", "BRIDGE_SCHEMA"),
    "BRIDGE_VERSION": (".bridge", "BRIDGE_VERSION"),
    "MartingaleStressBridge": (".bridge", "MartingaleStressBridge"),
    "StressBridgeConfig": (".bridge", "StressBridgeConfig"),
    "StressBridgeResult": (".bridge", "StressBridgeResult"),
    "StressPath": (".bridge", "StressPath"),
    "WASSERSTEIN_SCHEMA": (".wasserstein", "WASSERSTEIN_SCHEMA"),
    "WASSERSTEIN_VERSION": (".wasserstein", "WASSERSTEIN_VERSION"),
    "EndogenousWassersteinLinearLearner": (
        ".wasserstein",
        "EndogenousWassersteinLinearLearner",
    ),
    "WassersteinRobustConfig": (".wasserstein", "WassersteinRobustConfig"),
    "WassersteinRobustUpdate": (".wasserstein", "WassersteinRobustUpdate"),
